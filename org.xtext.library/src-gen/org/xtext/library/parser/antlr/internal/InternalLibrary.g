...
(
    ...
    { 
        $current = $this_ByAuthor_1.current; 
        afterParserOrEnumRuleCall();
    }
)
;
...
entryRuleAddAuthor returns [EObject current=null] 
	:
	{ newCompositeNode(grammarAccess.getAddAuthorRule()); }
	 iv_ruleAddAuthor=ruleAddAuthor 
	 { $current=$iv_ruleAddAuthor.current; } 
	 EOF 
;

// Rule AddAuthor
ruleAddAuthor returns [EObject current=null] 
    @init { enterRule(); 
    }
    @after { leaveRule(); }:
((
(
		lv_isbn_0_0=RULE_ISBN
		{
...
entryRuleByYear returns [EObject current=null] 
	:
	{ newCompositeNode(grammarAccess.getByYearRule()); }
	 iv_ruleByYear=ruleByYear 
	 { $current=$iv_ruleByYear.current; } 
	 EOF 
;

// Rule ByYear
ruleByYear returns [EObject current=null] 
    @init { enterRule(); 
    }
    @after { leaveRule(); }:
(	otherlv_0='Search' 
...
entryRuleByAuthor returns [EObject current=null] 
	:
	{ newCompositeNode(grammarAccess.getByAuthorRule()); }
	 iv_ruleByAuthor=ruleByAuthor 
	 { $current=$iv_ruleByAuthor.current; } 
	 EOF 
;

// Rule ByAuthor
ruleByAuthor returns [EObject current=null] 
    @init { enterRule(); 
    }
    @after { leaveRule(); }:
(	otherlv_0='Search' 
