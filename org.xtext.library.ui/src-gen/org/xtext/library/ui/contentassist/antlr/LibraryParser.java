...
* generated by Xtext
*/
package org.xtext.library.ui.contentassist.antlr;
...
public class LibraryParser extends AbstractContentAssistParser {
	...
	@Override
	protected org.xtext.library.ui.contentassist.antlr.internal.InternalLibraryParser createParser() {
		org.xtext.library.ui.contentassist.antlr.internal.InternalLibraryParser result = new org.xtext.library.ui.contentassist.antlr.internal.InternalLibraryParser(null);
		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getAddAuthorAccess().getGroup(), "rule__AddAuthor__Group__0");
					put(grammarAccess.getByYearAccess().getGroup(), "rule__ByYear__Group__0");
					put(grammarAccess.getByAuthorAccess().getGroup(), "rule__ByAuthor__Group__0");
					put(grammarAccess.getLendAccess().getGroup(), "rule__Lend__Group__0");
					put(grammarAccess.getAddAccess().getGroup(), "rule__Add__Group__0");
					put(grammarAccess.getAddAccess().getGroup_10(), "rule__Add__Group_10__0");
					put(grammarAccess.getAddUserAccess().getGroup(), "rule__AddUser__Group__0");
					...
					put(grammarAccess.getShowUserAccountAccess().getGroup(), "rule__ShowUserAccount__Group__0");
					...
					put(grammarAccess.getAddAuthorAccess().getIsbnAssignment_0(), "rule__AddAuthor__IsbnAssignment_0");
					put(grammarAccess.getAddAuthorAccess().getAuthorAssignment_2(), "rule__AddAuthor__AuthorAssignment_2");
					put(grammarAccess.getByYearAccess().getYearAssignment_4(), "rule__ByYear__YearAssignment_4");
					put(grammarAccess.getByAuthorAccess().getAuthorAssignment_4(), "rule__ByAuthor__AuthorAssignment_4");
					put(grammarAccess.getLendAccess().getIsbnAssignment_2(), "rule__Lend__IsbnAssignment_2");
					put(grammarAccess.getLendAccess().getFirstnameAssignment_4(), "rule__Lend__FirstnameAssignment_4");
					put(grammarAccess.getLendAccess().getSecondnameAssignment_5(), "rule__Lend__SecondnameAssignment_5");
					put(grammarAccess.getAddAccess().getIsbnAssignment_2(), "rule__Add__IsbnAssignment_2");
					...
					put(grammarAccess.getRemoveAccess().getIsbnAssignment_2(), "rule__Remove__IsbnAssignment_2");
					put(grammarAccess.getReturnAccess().getIsbnAssignment_2(), "rule__Return__IsbnAssignment_2");
					put(grammarAccess.getReturnAccess().getFirstnameAssignment_4(), "rule__Return__FirstnameAssignment_4");
					put(grammarAccess.getReturnAccess().getSecondnameAssignment_5(), "rule__Return__SecondnameAssignment_5");
					put(grammarAccess.getCheckAccess().getIsbnAssignment_3(), "rule__Check__IsbnAssignment_3");
					put(grammarAccess.getAuthorAccess().getFirstnameAssignment_0(), "rule__Author__FirstnameAssignment_0");
					put(grammarAccess.getAuthorAccess().getSecondnameAssignment_1(), "rule__Author__SecondnameAssignment_1");
					put(grammarAccess.getShowAccess().getWhatAssignment_2(), "rule__Show__WhatAssignment_2");
					put(grammarAccess.getShowUserAccountAccess().getFirstnameAssignment_3(), "rule__ShowUserAccount__FirstnameAssignment_3");
					put(grammarAccess.getShowUserAccountAccess().getSecondnameAssignment_4(), "rule__ShowUserAccount__SecondnameAssignment_4");
	...
	protected Collection<FollowElement> getFollowElements(AbstractInternalContentAssistParser parser) {
		try {
			org.xtext.library.ui.contentassist.antlr.internal.InternalLibraryParser typedParser = (org.xtext.library.ui.contentassist.antlr.internal.InternalLibraryParser) parser;
